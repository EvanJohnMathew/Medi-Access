...
class ChoicePageWidget extends StatefulWidget {
  ...
  static String routeName = 'ChoicePage';
  static String routePath = '/choicePage';
                    ...
                    children: [
                      ...
                      Padding(
                        padding: EdgeInsetsDirectional.fromSTEB(
                            44.0, 8.0, 44.0, 0.0),
                        child: Text(
                          'Thanks for joining! Please select your role to continue\"',
                    ...
                    child: Align(
                      ...
                      child: Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            context.pushNamed(OnboardingDocWidget.routeName);
                          },
                          text: 'Doctor',
