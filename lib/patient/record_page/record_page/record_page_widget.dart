                        ...
                        Padding(
                          ...
                          child: StreamBuilder<List<UserDetailsRecord>>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              List<UserDetailsRecord> rowUserDetailsRecordList =
                                  snapshot.data!;
                              // Return an empty Container when the item does not exist.
                              if (snapshot.data!.isEmpty) {
                                return Container();
                              }
                              final rowUserDetailsRecord =
                                  rowUserDetailsRecordList.isNotEmpty
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        padding: EdgeInsetsDirectional.fromSTEB(
                                            0.0, 4.0, 0.0, 0.0),
                                        child: Text(
                                          rowUserDetailsRecord!.reference.id,
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                                                fontFamily: 'Rosemary',
                                    ...
                                    Padding(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            valueOrDefault<String>(
                                              columnUserDetailsRecord?.gender,
                                              'Gender',
                                            ),
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                    ...
                                    Padding(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            columnUserDetailsRecord!.phoneNumber
                                                .toString(),
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            InkWell(
                              ...
                              onTap: () async {
                                context.pushNamed(
                                    RecentVisitRecordWidget.routeName);
                              },
                              child: Text(
                                'See All',
                                style: FlutterFlowTheme.of(context)
                        ...
                        StreamBuilder<List<AppointmentRecord>>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            List<AppointmentRecord>
                                columnAppointmentRecordList = snapshot.data!;
                            if (columnAppointmentRecordList.isEmpty) {
                              return NoAppointmentsRecordWidget();
                            }
                              ...
                              child: Column(
                                ...
                                children: List.generate(
                                  ...
                                  final columnAppointmentRecord =
                                      columnAppointmentRecordList[columnIndex];
                                  return Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        0.0, 0.0, 0.0, 12.0),
                                    child: Container(
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            InkWell(
                              ...
                              onTap: () async {
                                context.pushNamed(
                                  MedicationHistoryRecordWidget.routeName,
                                  queryParameters: {
                                    ...
                                    return Padding(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            columnMedicationRecord.noOfTimes,
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                                  fontFamily: 'Rosemary',
