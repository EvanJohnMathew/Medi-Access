...
class _ProfilecreateWidgetState extends State<ProfilecreateWidget> {
  ...
  void initState() {
    ...
    _model.roleTextController ??= TextEditingController(text: widget!.patient);
    ...
    _model.emergencyContactNameTextController ??= TextEditingController();
    _model.emergencyContactNameFocusNode ??= FocusNode();
    _model.emergencyContactNameFocusNode!
        .addListener(() => safeSetState(() {}));
    _model.emergencyContactNumberTextController ??= TextEditingController();
    _model.emergencyContactNumberFocusNode ??= FocusNode();
    _model.emergencyContactNumberFocusNode!
        .addListener(() => safeSetState(() {}));
    _model.emergencyContactNumberMask =
        MaskTextInputFormatter(mask: '##########');
    _model.relationWithPatientTextController ??= TextEditingController();
    _model.relationWithPatientFocusNode ??= FocusNode();
    _model.relationWithPatientFocusNode!.addListener(() => safeSetState(() {}));
  }
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  TextFormField(
                                    controller: _model
                                        .emergencyContactNameTextController,
                                    focusNode:
                                        _model.emergencyContactNameFocusNode,
                                    autofocus: true,
                                    textCapitalization:
                                  ...
                                  TextFormField(
                                    controller: _model
                                        .emergencyContactNumberTextController,
                                    focusNode:
                                        _model.emergencyContactNumberFocusNode,
                                    autofocus: true,
                                    textCapitalization: TextCapitalization.none,
                                  ...
                                  TextFormField(
                                    controller: _model
                                        .relationWithPatientTextController,
                                    focusNode:
                                        _model.relationWithPatientFocusNode,
                                    autofocus: true,
                                    textCapitalization:
                                        TextCapitalization.words,
                                    obscureText: false,
                      ...
                      onPressed: () async {
                        if (_model.fullNameTextController.text != null &&
                          ...
                          if (_model.emailTextController.text != null &&
                            ...
                            if (_model.ageTextController.text != null &&
                                _model.ageTextController.text != '') {
                              if (_model.roleTextController.text != null &&
                                  _model.roleTextController.text != '') {
                                if (_model.datePicked != null) {
                                  if (_model.genderValue != null &&
                                      _model.genderValue != '') {
                                    if (_model.bloodGroupValue != null &&
                                      ...
                                      if (_model.addressTextController.text !=
                                        ...
                                        if (_model.phoneNumberTextController
                                            ...
                                            _model.phoneNumberTextController
                                                    .text !=
                                                '') {
                                          if (_model.emergencyContactNameTextController
                                                      .text !=
                                                  null &&
                                              _model.emergencyContactNameTextController
                                                      .text !=
                                                  '') {
                                            if (_model.emergencyContactNumberTextController
                                                        .text !=
                                                    null &&
                                                _model.emergencyContactNumberTextController
                                                        .text !=
                                                    '') {
                                              if (_model.relationWithPatientTextController
                                                          .text !=
                                                      null &&
                                                  _model.relationWithPatientTextController
                                                          .text !=
                                                      '') {
