...
import 'appointment_page_detailed_today_model.dart';
export 'appointment_page_detailed_today_model.dart';

class AppointmentPageDetailedTodayWidget extends StatefulWidget {
  const AppointmentPageDetailedTodayWidget({
    super.key,
  ...
  static String routeName = 'AppointmentPageDetailedToday';
  static String routePath = '/appointmentPageDetailedToday';

  @override
  State<AppointmentPageDetailedTodayWidget> createState() =>
      _AppointmentPageDetailedTodayWidgetState();
}

class _AppointmentPageDetailedTodayWidgetState
    extends State<AppointmentPageDetailedTodayWidget> {
  late AppointmentPageDetailedTodayModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AppointmentPageDetailedTodayModel());
