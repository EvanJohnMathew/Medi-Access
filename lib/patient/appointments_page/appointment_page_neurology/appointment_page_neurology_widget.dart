...
import 'appointment_page_neurology_model.dart';
export 'appointment_page_neurology_model.dart';

class AppointmentPageNeurologyWidget extends StatefulWidget {
  const AppointmentPageNeurologyWidget({
    super.key,
    String? neurology,
  }) : this.neurology = neurology ?? 'Neurology';

  final String neurology;

  static String routeName = 'AppointmentPageNeurology';
  static String routePath = '/appointmentPageNeurology';

  @override
  State<AppointmentPageNeurologyWidget> createState() =>
      _AppointmentPageNeurologyWidgetState();
}

class _AppointmentPageNeurologyWidgetState
    extends State<AppointmentPageNeurologyWidget> {
  late AppointmentPageNeurologyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AppointmentPageNeurologyModel());
