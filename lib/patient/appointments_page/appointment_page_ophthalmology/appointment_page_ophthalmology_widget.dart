...
import 'appointment_page_ophthalmology_model.dart';
export 'appointment_page_ophthalmology_model.dart';

class AppointmentPageOphthalmologyWidget extends StatefulWidget {
  const AppointmentPageOphthalmologyWidget({
    super.key,
    String? ophthalmology,
  }) : this.ophthalmology = ophthalmology ?? 'Ophthalmology';

  final String ophthalmology;

  static String routeName = 'AppointmentPageOphthalmology';
  static String routePath = '/appointmentPageOphthalmology';

  @override
  State<AppointmentPageOphthalmologyWidget> createState() =>
      _AppointmentPageOphthalmologyWidgetState();
}

class _AppointmentPageOphthalmologyWidgetState
    extends State<AppointmentPageOphthalmologyWidget> {
  late AppointmentPageOphthalmologyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AppointmentPageOphthalmologyModel());
                                ...
                                StreamBuilder<List<DoctorDetailsRecord>>(
                                  stream: queryDoctorDetailsRecord(
                                    queryBuilder: (doctorDetailsRecord) =>
                                      ...
                                      'Specialization',
                                      isEqualTo: widget!.ophthalmology,
                                    ),
                                  ),
                                  builder: (context, snapshot) {
                                    // Customize what your widget looks like when it's loading.
