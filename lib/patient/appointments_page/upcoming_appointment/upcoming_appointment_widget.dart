...
import '/patient/null_component_page/no_appointments_upcoming_days/no_appointments_upcoming_days_widget.dart';
import 'dart:ui';
...
class UpcomingAppointmentWidget extends StatefulWidget {
  ...
  static String routeName = 'UpcomingAppointment';
  static String routePath = '/upcomingAppointment';
                            ...
                            StreamBuilder<List<AppointmentRecord>>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                if (listViewAppointmentRecordList.isEmpty) {
                                  return Center(
                                    child: NoAppointmentsTodayWidget(),
                                  );
                                }
                                ...
                                return ListView.separated(
                                  ...
                                  itemBuilder: (context, listViewIndex) {
                                    ...
                                    return InkWell(
                                      ...
                                      onTap: () async {
                                        context.pushNamed(
                                          AppointmentPageDetailedTodayWidget
                                              .routeName,
                                          queryParameters: {
                                            ...
                                            'date': serializeParam(
                                              listViewAppointmentRecord.date,
                                              ParamType.DateTime,
                                            ),
                                            'time': serializeParam(
                                              listViewAppointmentRecord.time,
                                              ParamType.DateTime,
                                            ),
                                            ...
                                            'rid': serializeParam(
                                              listViewAppointmentRecord.idapp,
                                              ParamType.String,
                                            ),
                                          }.withoutNulls,
                                        );
                          ...
                          children: [
                            ...
                            StreamBuilder<List<AppointmentRecord>>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                if (listViewAppointmentRecordList.isEmpty) {
                                  return Center(
                                    child: NoAppointmentsUpcomingDaysWidget(),
                                  );
                                }
                                ...
                                return ListView.separated(
                                  ...
                                  itemBuilder: (context, listViewIndex) {
                                    ...
                                    return InkWell(
                                      ...
                                      onTap: () async {
                                        context.pushNamed(
                                          AppointmentPageDetailedUpcomingWidget
                                              .routeName,
                                          queryParameters: {
                                            'doctorname': serializeParam(
                                              '',
