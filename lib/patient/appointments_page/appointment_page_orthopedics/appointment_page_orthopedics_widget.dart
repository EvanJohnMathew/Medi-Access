...
import 'appointment_page_orthopedics_model.dart';
export 'appointment_page_orthopedics_model.dart';

class AppointmentPageOrthopedicsWidget extends StatefulWidget {
  const AppointmentPageOrthopedicsWidget({
    super.key,
    String? orthopedics,
  }) : this.orthopedics = orthopedics ?? 'Orthopedics';

  final String orthopedics;

  static String routeName = 'AppointmentPageOrthopedics';
  static String routePath = '/appointmentPageOrthopedics';

  @override
  State<AppointmentPageOrthopedicsWidget> createState() =>
      _AppointmentPageOrthopedicsWidgetState();
}

class _AppointmentPageOrthopedicsWidgetState
    extends State<AppointmentPageOrthopedicsWidget> {
  late AppointmentPageOrthopedicsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AppointmentPageOrthopedicsModel());
