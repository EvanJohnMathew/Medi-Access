...
import 'appointment_page_cardiology_model.dart';
export 'appointment_page_cardiology_model.dart';

class AppointmentPageCardiologyWidget extends StatefulWidget {
  const AppointmentPageCardiologyWidget({
    super.key,
    String? cardiology,
  }) : this.cardiology = cardiology ?? 'Cardiology';

  final String cardiology;

  static String routeName = 'AppointmentPageCardiology';
  static String routePath = '/appointmentPageCardiology';

  @override
  State<AppointmentPageCardiologyWidget> createState() =>
      _AppointmentPageCardiologyWidgetState();
}

class _AppointmentPageCardiologyWidgetState
    extends State<AppointmentPageCardiologyWidget> {
  late AppointmentPageCardiologyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AppointmentPageCardiologyModel());
