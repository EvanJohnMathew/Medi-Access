...
import 'appointment_page_obstetrics_gynecology_model.dart';
export 'appointment_page_obstetrics_gynecology_model.dart';

class AppointmentPageObstetricsGynecologyWidget extends StatefulWidget {
  const AppointmentPageObstetricsGynecologyWidget({
    super.key,
    String? obstetricsGynecology,
  }) : this.obstetricsGynecology =
            obstetricsGynecology ?? 'ObstetricsGynecology';

  final String obstetricsGynecology;

  static String routeName = 'AppointmentPageObstetricsGynecology';
  static String routePath = '/appointmentPageObstetricsGynecology';

  @override
  State<AppointmentPageObstetricsGynecologyWidget> createState() =>
      _AppointmentPageObstetricsGynecologyWidgetState();
}

class _AppointmentPageObstetricsGynecologyWidgetState
    extends State<AppointmentPageObstetricsGynecologyWidget> {
  late AppointmentPageObstetricsGynecologyModel _model;
  ...
  void initState() {
    super.initState();
    _model =
        createModel(context, () => AppointmentPageObstetricsGynecologyModel());
                                ...
                                StreamBuilder<List<DoctorDetailsRecord>>(
                                  stream: queryDoctorDetailsRecord(
                                    queryBuilder: (doctorDetailsRecord) =>
                                      ...
                                      'Specialization',
                                      isEqualTo: widget!.obstetricsGynecology,
                                    ),
                                  ),
                                  builder: (context, snapshot) {
                                    // Customize what your widget looks like when it's loading.
