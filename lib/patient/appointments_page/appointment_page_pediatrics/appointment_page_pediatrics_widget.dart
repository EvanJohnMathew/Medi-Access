...
import 'appointment_page_pediatrics_model.dart';
export 'appointment_page_pediatrics_model.dart';

class AppointmentPagePediatricsWidget extends StatefulWidget {
  const AppointmentPagePediatricsWidget({
    super.key,
    String? pediatrics,
  }) : this.pediatrics = pediatrics ?? 'Pediatrics';

  final String pediatrics;

  static String routeName = 'AppointmentPagePediatrics';
  static String routePath = '/appointmentPagePediatrics';

  @override
  State<AppointmentPagePediatricsWidget> createState() =>
      _AppointmentPagePediatricsWidgetState();
}

class _AppointmentPagePediatricsWidgetState
    extends State<AppointmentPagePediatricsWidget> {
  late AppointmentPagePediatricsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AppointmentPagePediatricsModel());
