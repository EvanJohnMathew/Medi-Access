...
import 'schema/a_i_questionasked_record.dart';
import 'schema/medication_record.dart';
import 'schema/users_record.dart';
import 'schema/doctor_details_record.dart';
...
export 'schema/a_i_questionasked_record.dart';
export 'schema/medication_record.dart';
export 'schema/users_record.dart';
export 'schema/doctor_details_record.dart';
...
/// Functions to query AIQuestionaskedRecords (as a Stream and as a Future).
Future<int> queryAIQuestionaskedRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      AIQuestionaskedRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<AIQuestionaskedRecord>> queryAIQuestionaskedRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      AIQuestionaskedRecord.collection,
      AIQuestionaskedRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<AIQuestionaskedRecord>> queryAIQuestionaskedRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
/// Functions to query DoctorDetailsRecords (as a Stream and as a Future).
Future<int> queryDoctorDetailsRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      DoctorDetailsRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<DoctorDetailsRecord>> queryDoctorDetailsRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      DoctorDetailsRecord.collection,
      DoctorDetailsRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<DoctorDetailsRecord>> queryDoctorDetailsRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
